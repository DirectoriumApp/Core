...
_A plain-language overview of where Introibo Core is headed. Each version links to its tracking
...
## 🚧 In progress — [v0.1.0](https://github.com/Introibo-App/Core/milestone/1)
...
## 🗓️ Next — [v0.2.0](https://github.com/Introibo-App/Core/milestone/3)
...
## 🔭 Future
- **[v0.3.0](https://github.com/Introibo-App/Core/milestone/2) — 1954 & 1955 engines.** The pre-1955
...
- **[v0.4.0](https://github.com/Introibo-App/Core/milestone/10) — Calendrical & fasting layers.** The
...
- **[v1.0.0](https://github.com/Introibo-App/Core/milestone/4) — Platform launch (traditional-complete).**
...
- **[v1.1.0](https://github.com/Introibo-App/Core/milestone/16) — Novus Ordo calendar engine.** Ranks,
...
- **[v1.2.0](https://github.com/Introibo-App/Core/milestone/5) — Text infrastructure + Little Office of
...
- **[v1.3.0](https://github.com/Introibo-App/Core/milestone/6) — Roman Missal (bilingual Mass).**
  Ordinary, Propers, prefaces, sequences & tracts, ritual Masses — plus the **first-class lectionary
  model**.
- **[v1.4.0](https://github.com/Introibo-App/Core/milestone/7) — Full Roman Breviary (bilingual).** All
  hours, psalter, propers, commons, and hymns (incl. preces/suffrages/Quicumque accuracy).
- **[v1.5.0](https://github.com/Introibo-App/Core/milestone/11) — Tridentine (1570 / ~1906) + interim
  rite.** The Tridentine calendar plus the 1965/67 interim-rite stub. Historical depth and the widest
  comparison span.
- **[v1.6.0](https://github.com/Introibo-App/Core/milestone/12) — Novus Ordo Missal texts (1969+).** The
  NO Missal texts + NO lectionary cycles (A/B/C, I/II). Bilingual where licensed/PD, else incipit +
  citation.
- **[v1.7.0](https://github.com/Introibo-App/Core/milestone/13) — Historical Office psalters.** The
  pre-Pius-X and 1911 Divino Afflatu psalters + the Divino Afflatu office-structure deltas.
- **[v1.8.0](https://github.com/Introibo-App/Core/milestone/17) — Liturgia Horarum (1971).** The Novus
  Ordo Divine Office — no Prime, the Office of Readings, the four-week psalter. Enables 1962↔LOTH office
  comparison.
- **[v2.0.0](https://github.com/Introibo-App/Core/milestone/15) — Comparison flagship & rite framework.**
...
- **[v2.1.0](https://github.com/Introibo-App/Core/milestone/8) — Office for American Laity.** The 1888
  Baltimore Manual + Bute translation.
- **[v2.2.0](https://github.com/Introibo-App/Core/milestone/9) — Monastic Diurnal (1963).** Plus reserved
  full Matins/Nocturns & the Thesaurus 1977 schemas.
- **[v2.3.0](https://github.com/Introibo-App/Core/milestone/14) — Supporting corpora.** Roman
  Martyrology, Gregorian chant (GABC), devotions, particular/regional calendars, stational churches, and
  calendar-linked blessings.
- **[v2.4.0](https://github.com/Introibo-App/Core/milestone/18) — Rituale Romanum.** The Rituale Romanum
  corpus + the Pontificale (reserved).
- **[v3.0.0](https://github.com/Introibo-App/Core/milestone/19) — Rite framework: Western uses
  (reserved).** Ambrosian, Mozarabic, Sarum, Braga, Lyonese, Carthusian.
- **[v3.1.0](https://github.com/Introibo-App/Core/milestone/20) — Rite framework: religious-order rites
  (reserved).** Dominican, Norbertine; Cistercian/Carmelite overlays.
- **[v3.2.0](https://github.com/Introibo-App/Core/milestone/21) — Rite framework: Byzantine (reserved).**
...
- **[v3.3.0](https://github.com/Introibo-App/Core/milestone/22) — Rite framework: other Eastern
