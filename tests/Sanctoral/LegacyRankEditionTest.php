...
final class LegacyRankEditionTest extends TestCase
{
    ...
    public function testTheDivinoAfflatuEditionMaterialisesAsItsOwnCorpusDirectory(): void
    {
        ...
        // pre-1955 double scheme; 28 feasts the 1955/1960 reforms SUPPRESSED, authored as
        // notInBaseEdition; the materialised sanctoral octaves (#65 — 21 octave observances);
        // and the pre-1955 vigils (#66 — 13). Every one carries a native legacy grade.
        self::assertCount(290 + 28 + 21 + 13, $entries);
